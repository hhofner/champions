defmodule Champions.Accounts.User do
  ...
  schema "users" do
    ...
    has_many :owned_groups, Champions.Groups.Group, foreign_key: :owner_id # double check if its really owner_id
    has_many :group_memberships, Champions.Groups.GroupMembership
