    ...
    case Champions.Groups.create_group_with_user(group_params, user_id) do
      {:ok, _} ->
        socket =
          ...
          |> assign(groups: Champions.Groups.list_groups_for_user(socket.assigns.current_user_id))
  ...
  def render(assigns) do
    ...
    <div class="flex-grow">
      ...
      <section class="flex flex-col">
        ...
        <button class="btn btn-primary" phx-click={show_modal("create-group-modal")}>Create New Group</button>
      </section>
      <.modal id="create-group-modal">
        ...
        <.simple_form for={@new_group_changeset} phx-submit="create_new_group">
          ...
          <.input field={@new_group_changeset[:league_id]} type="select" label="League" options={@available_leagues} />
          <div class="hidden"><.input  field={@new_group_changeset[:owner]} type="text" label="Owner" value={@current_user_id} /></div>
          <:actions>
